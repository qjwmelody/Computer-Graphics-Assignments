...
Student name: 
Student number: 
Hours spent on requirements (approx.): 20hours
Hours spent on extra credit (approx.): 20hours
...
Yes.
- Proper handling of boundaries for Loop subdivision: done
In Subdiv.cpp.

- Local coordinate frames on the curve: attempted
In curve.cpp. But there are some problems on the calculation of tangent vector.

- New colors to the vertices based on the age: attempted
In Subdiv.cpp. But changing the col has an effect on an area, rather than the vertices.

- Bezier interpolation for orientations: done
In cameraPath.cpp, without any test.
...
There were some problems I met and solved with checkpoints in hours.
- To set V3 as zero vector, v3=0 is unwise:(
- The type converters like Vec4f are easily forgotten.
...
Great assignment handout! Thank you. I practiced what was learned in classes, and found tons of interesting knowledge to master.
