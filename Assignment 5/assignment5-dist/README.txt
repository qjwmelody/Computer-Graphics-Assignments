...
Student name: 
Student number: 
Hours spent on requirements (approx.): 24
...
It would be better if we could have more time on Assignment 5. Perhaps the schedule should be changed by reducing the time spent on previous assignments:)
