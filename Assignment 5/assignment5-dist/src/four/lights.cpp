...
void PointLight::getIncidentIllumination(const Vec3f& p,
	...
	auto attenuation = 1.0f / (quadratic_attenuation_ * FW::pow(distance, 2) + linear_attenuation_ * distance + constant_attenuation_);
	incident_intensity = intensity_ * attenuation;
