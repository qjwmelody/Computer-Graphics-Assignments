...
private:
	...
	// Initial translation is {0, 0, 0}
	Vec3f			model_translation_;

	// Extra: Current scale multiple
	//Initial multiple is {1, 1, 1}
	Vec3f			model_sx_=Vec3f(1, 1, 1);
	// Current rotation
	// Initialized as 0.0f in App::App()
	float			model_rotation_;
